  ...
  - name: 
    items:
      ...
      - name: SQL
        ...
        icon: circle-stack
      - name: NLP
        description: '预训练模型与大语言模型'
        percent: 50
        icon: microphone
      - name: Python
        description: '仿真、计算与分析'
        percent: 80
        icon: code-bracket-square
      - name: 网络分析
        description: '复杂系统建模与级联效应（ABM）'
        percent: 95
...
从事计算城市科学研究，运用复杂系统与机器学习方法理解城市的可持续性与韧性。
